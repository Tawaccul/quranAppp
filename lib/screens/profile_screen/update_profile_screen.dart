...
class UpdateProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(onPressed: () => Get.back(), icon: const Icon(LineAwesomeIcons.accessible)),
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      height: 35,
                      decoration:
                      BoxDecoration(borderRadius: BorderRadius.circular(100), color: buttonColor),
              ...
              Form(
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      decoration: const InputDecoration(
                          label: Text('tPhoneNo'), prefixIcon: Icon(LineAwesomeIcons.clone)),
                    ),
                    const SizedBox(height: 30 - 20),
                    TextFormField(
                      obscureText: true,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: const Text('tEditProfile', style: TextStyle(color: titleColor)),
                      ),
                    ),
                    const SizedBox(height: 30),
